...
public class BangunDatarStrategy {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Luas Layang-Layang : "+hitungcontext.executeStrategy(KonversiLuaslayanglayang));
        hitungcontext = new HitungContext(new LayangLayang());
        System.out.println("Keliling Layang-Layang : "+hitungcontext.executeStrategy(KonversiKelilinglayanglayang));
    }
